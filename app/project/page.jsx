    ...
    <div>
      ...
      <div className="relative flex items-center justify-center h-[625px] bg-white overflow-hidden">
        <div className="relative text-center ">
          <p className="mb-4 mt-30 text-5xl font-bold text-[#806D9C] animate__animated animate__fadeInUp">
              ...
              >
                {projects.map((project, idx) => (
                  <Link key={idx} href={`/project/${project.id}`}>
                    <div className="relative w-full h-60 sm:h-72 md:h-80 lg:h-[28rem] rounded-2xl overflow-hidden group shadow-xl">
                      <Image
                        src={project.image}
                        alt={project.title}
                        fill
                    ...
                    <div className="mt-4 text-base font-bold text-start">
                      <p>{project.title}</p>
                    </div>
